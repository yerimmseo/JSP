...
<%
	...
	application.setAttribute("most", "야오스");
%>
<!DOCTYPE html>
<html>
<head>
...
<body>
	...
	<h3># EL을 통해 파라미터에 저장되어있는 값을 쉽게 출력하기</h3>
	<ol>
		<li>${param.name }</li>
		<li>${param.age }</li>
	...
	<ul>
		<li>산술: +, -, *, /, %, mod <br>
			11 mod 7의 결과: ${11 mod 7 }</li>
		<li>비교: ==, !=, .., eq, ne, lt, gt, le, ge <br> 
			3이 7보다 큰가요? ${3 > 7 }, ${3 gt 7 }</li>
		<li>논리: and, or, not, &&, ||, ! <br>
			${requestScope.most < sessionScope.most and most > requestScope.most }</li>
		<li>empty: "" 또는 null일 때 true <br>
			(자바로 치면 str == "" || str == null)
			<%
			...
			%>
			${empty value1 }, ${empty value2 }, ${empty value3 }</li>
		<li>삼항: condition ? yes : no <br> 
			${empty value3 ? '비어있음' : '안비어있음' }</li>
	</ul>
